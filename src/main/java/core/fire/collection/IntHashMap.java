 ...
 * 
 * <p>
 * <b> Do not use it in concurrent scenario </b>
 * 
 * @author lhl
 *
 * 2016年4月7日 下午2:39:32
 * @see io.netty.util.collection.IntObjectHashMap
 */
public class IntHashMap<V> implements Iterable<IntHashMap.Entry<V>>
{
    ...
    public void putAll(IntHashMap<V> sourceMap) {
            ...
            this.valueCollection = valueCollection = new AbstractCollection<V>() {
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() {
                        final Iterator<Entry<V>> iter = IntHashMap.this.iterator();
    ...
    private void growSize() {
        ...
        if (size > maxSize) {
            ...
            // Open addressing requires that we have at least 1 slot available.
            // Need to refresh
    ...
    /**
     * Adjusts the given capacity value to ensure that it's odd. Even capacities
     * can break probing.
     */
