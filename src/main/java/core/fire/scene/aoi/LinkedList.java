...
class LinkedList<E> extends AbstractSequentialList<E> implements List<E>, Deque<E>, Cloneable, java.io.Serializable
{
     ...
     */
    Node<E> linkBefore(E e, Node<E> succ) {
        // assert succ != null;
    ...
    /**
     * 在尾部添加一个元素，并返回插入元素的节点
     * 
     * @param element
     * @return
     */
    public Node<E> insertLast(E element) {
        return insert(size, element);
    }

    /**
     * 在头部添加一个元素，并返回插入元素的节点
     * 
     * @param element
     * @return
     */
    public Node<E> insertFirst(E element) {
     ...
     * @return
     */
    public Node<E> insertBefore(E e, Node<E> node) {
        return linkBefore(e, node);
    }
     ...
     * {@link Spliterator#SUBSIZED} and implements {@code trySplit} to permit
     * limited parallelism..
     *
